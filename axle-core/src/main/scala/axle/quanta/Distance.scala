...
case class Distance3() extends Quantum3

object Distance3 extends Quantum3 {
  ...
  def units[N: Field: Eq]: List[UnitOfMeasurement3[Distance3, N]] =
  ...
  def links[N: Field: Eq]: Seq[(UnitOfMeasurement3[Distance3, N], UnitOfMeasurement3[Distance3, N], Bijection[N, N])] =
    List[(UnitOfMeasurement3[Distance3, N], UnitOfMeasurement3[Distance3, N], Bijection[N, N])](
      (foot, mile, ScaleInt(5280)),
      (foot, meter, ScaleDouble(3.2808398950131235)),
      (kilometer, mile, ScaleDouble(1.609344)),
      (lightyear, parsec, ScaleDouble(3.26)),

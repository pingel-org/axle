...
object MoneyFlow {
  ...
  def converterGraphK2[N: Field: Eq, DG[_, _]](
    implicit evDG: DirectedGraph[DG[UnitOfMeasurement[MoneyFlow], N => N], UnitOfMeasurement[MoneyFlow], N => N]) =
    converterGraph[N, DG[UnitOfMeasurement[MoneyFlow], N => N]]

  def converterGraph[N: Field: Eq, DG](
    implicit evDG: DirectedGraph[DG, UnitOfMeasurement[MoneyFlow], N => N]) =

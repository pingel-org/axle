...
object AdjustForDirectCauses extends Rule {
  ...
  def parentObservations(m: Model[RandomVariable[_]], Xi: RandomVariable[_]): Option[immutable.Set[RandomVariable[_]]] = {
  ...
  def adjustForDirectCauses(m: Model[RandomVariable[_]], q: CausalityProbability, namer: VariableNamer, Xi: RandomVariable[_]): Option[Form] =

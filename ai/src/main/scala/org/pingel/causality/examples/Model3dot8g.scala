...
object Model3dot8g extends CausalModel("3.8g") {
	...
	addFunction(new Function(X, List(Z2, U1, U2, U3)))
	addFunction(new Function(Y, List(Z1, Z3, U1, U4)))
	addFunction(new Function(Z1, List(X, Z2)))
	addFunction(new Function(Z2, List(U3, U4)))
	addFunction(new Function(Z3, List(Z2, U2)))

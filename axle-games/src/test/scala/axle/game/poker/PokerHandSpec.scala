...
class PokerHandSpec extends FunSuite with Matchers {
  ...
  test("flush > two pair") {
    ...
    hand.description should contain("flush")
  ...
  test("three-of-a-kind vs three-of-a-kind") {
    ...
    hand.description should contain("three")
  ...
  test("four-of-a-kind vs four-of-a-kind") {
    ...
    hand.description should contain("four")

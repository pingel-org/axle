...
object Math {
  ...
  object Difference extends FormFactory {
  ...
  object Logarithm extends FormFactory {
    val arg1 = new Name("arg1")
    val arg2 = new Name("arg2")
    val lambda = new Lambda();
    lambda.add(arg1)
  ...
  object Negation extends FormFactory {
  ...
  object Product extends FormFactory {
    val arg1 = new Name("arg1")
    val arg2 = new Name("arg2")
    val lambda = new Lambda()
    lambda.add(arg1)
  ...
  object Quotient extends FormFactory {
  ...
  object Sigma extends FormFactory {
  ...
  object Square extends FormFactory {
    val arg1 = new Name("arg1")
    val lambda = new Lambda()
    lambda.add(arg1)

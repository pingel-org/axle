...
// ec: concurrent.ExecutionContextExecutor = scala.concurrent.impl.ExecutionContextImpl$$anon$3@1066a579[Running, parallelism = 6, size = 2, active = 0, running = 0, steals = 2, tasks = 0, submissions = 0]
val blocker = cats.effect.Blocker.liftExecutionContext(ec)
// blocker: cats.effect.Blocker = cats.effect.Blocker@1066a579
implicit val cs = cats.effect.IO.contextShift(ec)
// cs: cats.effect.ContextShift[cats.effect.IO] = cats.effect.internals.IOContextShift@36a20f75

val articlesIO = FederalistPapers.articles[cats.effect.IO](blocker)
// articlesIO: cats.effect.IO[List[Article]] = Map(
//   source = Async(
//     k = cats.effect.internals.IOBracket$$$Lambda$6758/0x000000080216dd80@302c88b1,
//     trampolineAfter = false
//   ),
//   f = axle.data.FederalistPapers$$$Lambda$6771/0x00000008021753f0@49de1100,
//   index = 0
// )
...
// ringLong: CRing[Long] = spire.std.LongAlgebra@6cb6382f
...
// normalizer: DoubleMatrix => PCAFeatureNormalizer[DoubleMatrix] = scala.Function2$$Lambda$6806/0x00000008021377c8@4a494b6b
...
confusion.show
// res1: String = """ 6 27  2 17 : 52 HAMILTON
//  0  3  0  0 :  3 HAMILTON AND MADISON
//  6  1  5  3 : 15 MADISON
//  0  4  0  1 :  5 JAY
//  0  3  2  6 : 11 HAMILTON OR MADISON
// 
// 12 38  9 27
// """
```

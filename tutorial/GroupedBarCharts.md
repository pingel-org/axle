...
//   ),
//   colorOf = <function2>,
//   hoverOf = axle.visualize.BarChartGrouped$$$Lambda$7209/0x00000008022789a8@65814e49,
...
// timeConverter: axle.quanta.UnitConverterGraph[Time, Double, DirectedSparseGraph[axle.quanta.UnitOfMeasurement[Time], Double => Double]] with axle.quanta.TimeConverter[Double] = axle.quanta.Time$$anon$1@5349d502
import timeConverter.second

val dataUpdates: Observable[Map[String, Double]] = intervalScan(initial, tick, 1d *: second)
// dataUpdates: Observable[Map[String, Double]] = monix.reactive.internal.operators.ScanObservable@689b5821
```

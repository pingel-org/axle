...
// ec: concurrent.ExecutionContextExecutor = scala.concurrent.impl.ExecutionContextImpl$$anon$3@1066a579[Running, parallelism = 6, size = 4, active = 0, running = 0, steals = 6, tasks = 0, submissions = 0]
...
// cs: cats.effect.ContextShift[cats.effect.IO] = cats.effect.internals.IOContextShift@57ad5e5b

val irisesIO = new Irises[cats.effect.IO](blocker)
// irisesIO: Irises[cats.effect.IO] = axle.data.Irises@59da9bfe
...
// la: algebra.LinearAlgebra[DoubleMatrix, Int, Int, Double] = axle.jblas.package$$anon$5@5bc3bf12

val normalizer = (PCAFeatureNormalizer[DoubleMatrix] _).curried.apply(0.98)
// normalizer: DoubleMatrix => PCAFeatureNormalizer[DoubleMatrix] = scala.Function2$$Lambda$6806/0x00000008021377c8@71811c24
...
confusion.show
// res0: String = """  0  49   1 :  50 Iris-setosa
//  14   0  36 :  50 Iris-versicolor
//  31   0  19 :  50 Iris-virginica
// 
//  45  49  56
// """
```
